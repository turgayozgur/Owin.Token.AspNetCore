...
namespace Owin.Token.AspNetCore
{
    ...
    public class AuthenticationProperties
    {
        ...
        {
            get => _dictionary.ContainsKey(IsPersistentKey);
            set
            {
        ...
        {
            get => _dictionary.TryGetValue(RedirectUriKey, out var value) ? value : null;
            set
            {
                if (value != null)
                {
        ...
        public DateTimeOffset? IssuedUtc
        {
            get
            {
                if (!_dictionary.TryGetValue(IssuedUtcKey, out var value)) return null;
        ...
        public DateTimeOffset? ExpiresUtc
        {
            get
            {
                if (!_dictionary.TryGetValue(ExpiresUtcKey, out var value)) return null;
                if (DateTimeOffset.TryParseExact(value, UtcDateTimeFormat, CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind, out var dateTimeOffset))
                {
                    return dateTimeOffset;
                }
        ...
        public bool? AllowRefresh
        {
            get
            {
                if (!_dictionary.TryGetValue(RefreshKey, out var value)) return null;
